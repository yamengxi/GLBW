...
parser = argparse.ArgumentParser(description='Train standard BadNets trojaned models.')
...
schedule = {
    ...
    'experiment_name': f'{model_type}_{model_name}_GTSRB_BadNets_{trigger_name}_random_location={random_location}_poisoning_rate={poisoning_rate}_y_target={y_target}'
}
...
schedule = {
    ...
    'save_dir': 'experiments',
    'experiment_name': f'{model_type}_{model_name}_CIFAR-10_BadNets_{trigger_name}_random_location={random_location}_poisoning_rate={poisoning_rate}_y_target={y_target}'
}
badnets.train(schedule)
