...
parser.add_argument('--weights', default=None, type=str,
                    help='use pre-trained model weights (default: None)')
parser.add_argument('--num_classes', default=100, type=int,
                    help='the number of classes (default: 100)')
...
def main():
    ...
    # create model
    print(f"=> creating model {args.arch}, using pre-trained model weights {args.weights}")
