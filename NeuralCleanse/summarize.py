...
summary = Summary(
    ...
    result_dirs=[
        '/disk/yamengxi/Backdoor/XAI/Backdoor_XAI/NeuralCleanse/now_experiments/BaselineMNISTNetwork_MNIST_fixed_square_3x3_init_cost0.0001',
        ...
        # '/disk/yamengxi/Backdoor/XAI/BackdoorBox_XAI/NeuralCleanse/adv_experiments/ResNet-18_GTSRB_BaseMix_global_seed666_deterministicFalse_2022-08-25_22:07:01',
...
# model.load_state_dict(torch.load('/data/yamengxi/XAI/BackdoorBox_XAI/experiments/ResNet-18_CIFAR-10_BadNets_2022-05-24_20:28:18/ckpt_epoch_200.pth'), strict=False)
...
# model=torchvision.models.__dict__[args.model_name](weights=None, num_classes=100)
# model.load_state_dict(torch.load('/disk/yamengxi/Backdoor/XAI/BackdoorBox_XAI/adv_experiments/ResNet-18_GTSRB_BaseMix_global_seed666_deterministicFalse_2022-08-25_22:07:01/ckpt_epoch_30.pth', map_location='cpu'), strict=False)
