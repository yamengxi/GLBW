...
schedule = {
    ...
    'distance': norm,
    'distance_v2': norm_v2,
    'probability_activation_function': ProbabilityActivationFunction('sigmoid', 1.0, 8.0),
    'max_distance': 2.0,
    ...
    'experiment_name': f'ResNet-18_GTSRB_BaseMix_{norm_v2}_global_seed{global_seed}_deterministic{deterministic}'
}
